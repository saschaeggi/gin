  ...
  Drupal.behaviors.formDescriptionToggle = {
    attach: context => {
      context.querySelectorAll(".help-icon__description-toggle").forEach(((elem, index) => {
        ...
        elem.setAttribute("aria-controls", "target"), elem.closest(".help-icon__description-container").querySelectorAll(".gin-details__description, .fieldset__description, .form-item__description").forEach((description => {
          ...
          event.currentTarget.focus(), event.currentTarget.closest(".help-icon__description-container").querySelectorAll(".gin-details__description, .fieldset__description, .form-item__description").forEach(((description, index) => {
            if (index > 1) return;
