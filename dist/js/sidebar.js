(($, Drupal) => {
  ...
  Drupal.behaviors.ginSidebar = {
    ...
    showSidebar: function() {
      const chooseStorage = window.innerWidth < 1024 ? "Drupal.gin.sidebarExpanded.mobile" : storageDesktop, showLabel = Drupal.t("Show sidebar panel");
    ...
    collapseSidebar: function() {
      const chooseStorage = window.innerWidth < 1024 ? "Drupal.gin.sidebarExpanded.mobile" : storageDesktop, hideLabel = Drupal.t("Hide sidebar panel");
