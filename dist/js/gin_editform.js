!function($, Drupal, drupalSettings) {
  Drupal.behaviors.ginEditForm = {
    attach: function() {
      ...
      newParent && 0 === newParent.querySelectorAll(".gin-sticky").length && (newParent.appendChild(sticky), 
      newParent.querySelectorAll('button[type="submit"], input[type="submit"]').forEach((function(el) {
