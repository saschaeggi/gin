!function() {
  ...
  if (localStorage.getItem("GinMetaOpen")) {
    var _style = document.createElement("style"), _className2 = "gin-meta-inline-styles";
    if (_style.className = _className2, "false" === localStorage.getItem("GinMetaOpen")) {
