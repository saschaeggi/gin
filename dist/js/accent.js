  ...
  Drupal.behaviors.ginAccent = {
    ...
    setCustomAccentColor: function() {
      ...
      if (accentColor) {
        ...
        style.className = className, style.innerHTML = `\n          [data-gin-accent="custom"] {\n            --colorGinPrimaryRGB: ${this.hexToRgb(accentColor)};\n            --colorGinPrimaryHover: ${this.shadeColor(accentColor, -10)};\n            --colorGinPrimaryActive: ${this.shadeColor(accentColor, -15)};\n            --colorGinAppBackgroundRGB: ${this.hexToRgb(this.mixColor("ffffff", strippedAccentColor, 97))};\n            --colorGinTableHeader: ${this.mixColor("ffffff", strippedAccentColor, 85)};\n            --colorGinStickyRGB: ${this.hexToRgb(this.mixColor("ffffff", strippedAccentColor, 92))};\n          }\n          .gin--dark-mode[data-gin-accent="custom"],\n          .gin--dark-mode [data-gin-accent="custom"] {\n            --colorGinPrimaryRGB: ${this.hexToRgb(darkAccentColor)};\n            --colorGinPrimaryHover: ${this.mixColor("ffffff", strippedAccentColor, 55)};\n            --colorGinPrimaryActive: ${this.mixColor("ffffff", strippedAccentColor, 50)};\n            --colorGinTableHeader: ${this.mixColor("2A2A2D", darkAccentColor, 88)};\n          }\n        `, 
    ...
    setCustomFocusColor: function() {
      ...
      if (accentColor) {
        ...
        const strippedAccentColor = accentColor.replace("#", ""), darkAccentColor = this.mixColor("ffffff", strippedAccentColor, 65), style = document.createElement("style"), className = "gin-custom-focus";
